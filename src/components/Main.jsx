...
const Main = () => {
    ...
    <center>
    <a href={`/projects`} className="links-container">Project</a>
    <a href={`https://drive.google.com/file/d/1gMpgNq1kPQNE-f2q6hM-M7dImRF8RYJ0/view?usp=sharing`} className="links-container-1">Resume</a>
    </center>
    </>)
    }
